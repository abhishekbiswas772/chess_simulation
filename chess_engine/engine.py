...
from logger import Logger, ChessBoardRepr
...
def write_to_file(board: ChessBoard, current_depth):
    global logger
    if board.depth == current_depth:
        logger.clear()
    board_repr = ChessBoardRepr(board.unicode_array_repr(), current_depth, board.evaluate())
